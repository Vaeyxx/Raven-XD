...
public class ChatBypass extends Module {
    ...
    private List<String> filteredWords = Arrays.asList("nigga", "retard", "nigger", "faggot", "chink", "tranny", "trans", "nigglet", "niggers", "tran", "trannies", "trannie", "goblok", "tolol", "memek");
    ...
    private String applyBypass(String message) {
        ...
        if (message.contains("l")) {
            return message.replace("l", "ĺ");
        }
        if (message.contains("m")) {
            return message.replace("m", "ḿ");
        }
